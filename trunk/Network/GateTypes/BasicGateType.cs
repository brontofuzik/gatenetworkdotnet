        ...
        : GateType
    {
            ...
            : base( name, inputs, outputs )
        {
            ...
            foreach (string transition in transitions)
            {
                ...
                for (int i = InputCount; i < TransitionLength; i++)
                {
            ...
            transitionFunction = new TransitionFunction( InputCount, OutputCount, dictionary );
        }
        ...
        {
            return transitionFunction.Evaluate( inputs );    
        }
